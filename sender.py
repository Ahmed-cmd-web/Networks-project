class SenderProcess:
    ...
    def set_outgoing_data(buffer):
        ...
        :param buffer: a python list of characters represent the outgoing message :return: no return value
        """
        SenderProcess.__buffer = buffer
        return
    @staticmethod
    def get_outgoing_data():
        """ To get the message the process would send out over the network :return: a python list of characters represent the outgoing message
        """
...
class RDTSender:
    ...
    def get_checksum(data):
        ...
        # TODO provide your own implementation checksum = None # you need to change that
        return ord(data)

    @staticmethod
    def clone_packet(packet):
        """ Make a copy of the outgoing packet
        :param packet: a python dictionary represent a packet :return: return a packet as python dictionary
        """
        pkt_clone = {
    ...
    def is_expected_seq(reply, exp_seq):
        ...
        :param reply: a python dictionary represent a reply sent by the receiver
        :param exp_seq: the sender expected sequence number ’0’ or ’1’ represented as a
        character
        :return: True -> if ack in the reply match the expected sequence number otherwise
        False """
        # TODO provide your own implementation
        return exp_seq==reply['ack']
    ...
    def rdt_send(self, process_buffer):
        ...
        :param process_buffer: a list storing the message the sender process wish to send
